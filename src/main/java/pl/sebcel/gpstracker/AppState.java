...
public class AppState {
    ...
    private Hashtable pluginsStatuses = new Hashtable();
    ...
    public Hashtable getPluginsStatuses() {
        return pluginsStatuses;
    }
    ...
    public void setPluginStatus(String pluginID, PluginStatus status) {
        pluginsStatuses.put(pluginID,  status);
        notifyListeners();
    }
