...
public class CustomCoordinates extends QualifiedCoordinates {
    ...
    public CustomCoordinates(QualifiedCoordinates qualifiedCoordinates) {
        super(qualifiedCoordinates.getLatitude(), qualifiedCoordinates.getLongitude(), qualifiedCoordinates.getAltitude(), qualifiedCoordinates.getHorizontalAccuracy(), qualifiedCoordinates.getVerticalAccuracy());
